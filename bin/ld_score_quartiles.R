...
getwd()
file_dir = getwd()
file_names <- list.files(path = file_dir, pattern = paste("*.score.ld$", sep = ""), full.names=TRUE)
...
write_lines(ld1_snp, paste(file_dir,"/merged.score.ld.Q000-Q025.txt", sep = ""))
write_lines(ld2_snp, paste(file_dir,"/merged.score.ld.Q025-Q050.txt", sep = ""))
write_lines(ld3_snp, paste(file_dir,"/merged.score.ld.Q050-Q075.txt", sep = ""))
write_lines(ld4_snp, paste(file_dir,"/merged.score.ld.Q075-Q100.txt", sep = ""))
